export interface Env {
	...
	WEBSITE_URL?: string;
	DEVELOPER_DISCORD_USER_IDS?: string;
	SUPPORT_REPORT_CHANNEL_ID?: string;
	PATCH_INVITE_URL?: string;
	PROMO_KIT_URL?: string;
	REPORT_DM_IMAGE_URL?: string;
}
...
export type CommandModule = {
	...
	handle: (interaction: DiscordInteraction, env: Env, runtime?: CommandRuntime) => Promise<Response>;
};
