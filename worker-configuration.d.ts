/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 12a4bc5bfff34e1087dcaf1b5a097730)
// Runtime types generated with workerd@1.20260811.1 2026-05-13 nodejs_compat
interface __BaseEnv_Env {
	USER_PREFERENCES: KVNamespace;
	SUPPORT_SERVER_URL: "https://discord.gg/QW7CZczhT4";
	WEBSITE_URL: "https://discord-bot.robbeswinnen.workers.dev";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPPORT_SERVER_URL" | "WEBSITE_URL">> {}
}
declare module "*.css" {
	const value: string;
